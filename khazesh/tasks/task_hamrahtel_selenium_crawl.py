...
# from webdriver_manager.chrome import ChromeDriverManagerfrom fake_useragent import UserAgent
...
def scroll_until_end_of_page(driver:Chrome, wait_time_for_each_load:int = 3):
    ...
    while True: 
        ...
        time.sleep(wait_time_for_each_load)  
...
def hamrahtel_crawler(self):
    try:
        ...
        scroll_until_end_of_page(driver, wait_time_for_each_load=2)
