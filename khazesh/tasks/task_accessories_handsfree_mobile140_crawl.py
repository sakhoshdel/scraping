    ...
    try:
        ...
        for brand in crawled_mobile_brands:
            ...
            try:
                ...
                accessories_update_code_execution_state(SITE, 'handsfree', False, '❌ خطا در اتصال به سرور یا دریافت پاسخ:')

                print(e)
                continue
            except ValueError:
                accessories_update_code_execution_state(SITE, 'handsfree', False, 'خطا در تبدیل پاسخ به JSON')
            ...
            if "data" not in data or not isinstance(data["data"], dict):
                ...
                accessories_update_code_execution_state(SITE, 'handsfree', False, "❌ کلید 'data' در پاسخ موجود نیست یا ساختار نادرست دارد.")
                continue
