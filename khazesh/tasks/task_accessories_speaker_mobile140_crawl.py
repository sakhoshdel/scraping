    ...
    try:
        ...
        for brand in crawled_mobile_brands:
            ...
            try:
                ...
                accessories_update_code_execution_state(SITE, 'speaker', False, '❌ خطا در اتصال به سرور یا دریافت پاسخ:')

                print(e)
                continue
            except ValueError:
                accessories_update_code_execution_state(SITE, 'speaker', False, 'خطا در تبدیل پاسخ به JSON')
