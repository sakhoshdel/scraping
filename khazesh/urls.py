...
urlpatterns = [
    ...
    path('laptop', search_laptop, name="laptop_page"),
    ...
    path('ajax_search_laptop/', ajax_search_laptop, name="ajax_search_laptop"),
    path('site_status/', site_status, name="site_status"),
    path('set_custom_mobile_id/', set_custom_mobile_id, name="set_custom_mobile_id"),
    path('set_custom_laptop_id/', set_custom_laptop_id, name="set_custom_laptop_id"),
