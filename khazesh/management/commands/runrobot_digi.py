...
with open('/home/bm7/projects/scraping_bartardigital/khazesh/digi_kala8.csv', "r") as f:
    reader = csv.reader(f)
    header = next(reader)
    ...
    for row in reader:
        ...
        if _object_dict.get('active'):
            ...
            queryset = Mobile.objects.filter(mobile_digi_id=_object_dict.get('mobile_digi_id'), color_hex=_object_dict.get(
