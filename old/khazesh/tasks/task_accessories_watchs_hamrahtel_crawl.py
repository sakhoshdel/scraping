        ...
        "variables": {
            ...
            "where": {
                "attributes": [
                    {
                        "slug": "brand",
                        "values": ["ay-my-lb", "hylw", "mybrw", "pl", "smswng", "myzfyt", "khyslkht", "shyywmy", "ty-sy-ch", "hwwy"]
                    }
                ],
                "isAvailable": True,
                "stockAvailability": "IN_STOCK",
...
def accessories_watchs_hamrahtel_crawler(self):
    ...
    try:
        ...
        if not isinstance(all_mobile_ids, list):
            accessories_update_code_execution_state('Hamrahtel', 'watchs', False, all_mobile_ids)
            return
